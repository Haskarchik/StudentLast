      ...
      <div className="wrapper-navbar">
        ...
        <div className="navbar-items">
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}`}>
              {Routes.main_page}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/aboutus`}>
              {Routes.aboutUs}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/services/1`}>
              {Routes.services}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/reviews/all/1`}>
              {Routes.reviews}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/performer`}>
              {Routes.performer}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/blog`}>
              {Routes.blog}
            </Link>
          </div>
          <div className="navbar-item-box">
            <Link className="navbar-item" href={`/${lang}/contact`}>
              {Routes.contact}
            </Link>
          </div>
        </div>
